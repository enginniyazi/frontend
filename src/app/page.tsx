...
// Veri çeken fonksiyonlar (değişiklik yok)
...
// Not: Aktif Kampanyalar fonksiyonunu şimdilik eklemiyoruz, önce bu tasarımı oturtalım.

export default async function HomePage() {
  const latestCourses = await getLatestCourses();

  return (
    // En dış sarmalayıcı, sayfanın tamamını kaplar ve içeriği ortalar
    <div className="w-full">
      {/* 1. BÖLÜM: KAHRAMAN (HERO) BÖLÜMÜ */}
      <Hero />

      {/* 2. BÖLÜM: ÖNE ÇIKAN KURSLAR */}
      {latestCourses.length > 0 && (
        <section className="py-16 bg-gray-100">
          <div className="container mx-auto px-4">
            <div className="text-center mb-12">
              <h2 className="text-3xl md:text-4xl font-bold">
                En Popüler Kurslarımız
              </h2>
              <p className="mt-2 text-gray-600">
                Binlerce öğrencinin kariyer yolculuğuna başladığı yer.
              </p>
            </div>
